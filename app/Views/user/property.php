        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
            <div class="position-sticky pt-3">
                ...
                <div class="text-center mb-6">
                    <img src="<?= base_url('assets/images/logo.png') ?>" alt="Logo" class="img-fluid" style="width: 120px;">
                </div>
                <!-- Sidebar Navigation -->
            ...
            <div class="row mt-4">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a class="btn btn-primary" href="<?= base_url() ?>user/add">Add Property</a>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($UserData1 as $Supplier): ?>
                                            <tr>
                                                <td><?= $Supplier->PropertyNo; ?></td>
                                                <td><?= $Supplier->EntityName; ?></td>
                                                <td><?= $Supplier->ItemDescription; ?></td>
                                                <td><?= $Supplier->StockIn; ?></td>
                                                <td><?= $Supplier->StockOut; ?></td>
