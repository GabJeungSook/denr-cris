                    ...
                    <form action="<?=base_url();?>user/add" method="POST">
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group m-3"><label class="form-label">Contact Number</label>
                                    <input type="text" class="form-control" name="ContactNo"></div>
                                    <p class="text-danger"><?= validation_show_error('ContactNo')?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group m-3"><label class="form-label">Status</label>
